...
class _DataExportConfigPageState extends State<DataExportConfigPage> {
  ...
  Future<void> initPluginConfigList() async {
    List<PluginConfig> resList = await pluginService.pluginList(pluginType: 'DataOutput');
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text.rich(TextSpan(
                                  ...
                                  children: [
                                    TextSpan(
                                        text: ' ${_pluginConfigMap[exportConfig.pluginId]?.name}',
                                        style: const TextStyle(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    FilledButton(
                      child: const Text('编辑'),
                      onPressed: () {
                        router.goNamed('exportConfigEdit',pathParameters: {
                          'id': exportConfig.id.toString()
                        });
                      },
                    ),
                    FilledButton(
                      child: const Text('群组管理'),
                      onPressed: () =>router.pushNamed('deviceGroup',
                          pathParameters: {
                            'deviceId':exportConfig.id.toString()
                          }),
                    ),
                    FilledButton(
                      child: const Text('删除'),
